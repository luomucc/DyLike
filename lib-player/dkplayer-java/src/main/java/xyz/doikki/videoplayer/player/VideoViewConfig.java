...
public class VideoViewConfig {
    ...
    // 音频渐入渐出配置
    public final boolean mEnableAudioFade;
    public final int mAudioFadeInDuration;
    public final int mAudioFadeOutDuration;
    ...
    private VideoViewConfig(Builder builder) {
        ...
        mEnableAudioFade = builder.mEnableAudioFade;
        mAudioFadeInDuration = builder.mAudioFadeInDuration;
        mAudioFadeOutDuration = builder.mAudioFadeOutDuration;
    }
    ...
    public final static class Builder {
        ...
        private boolean mEnableAudioFade;
        private int mAudioFadeInDuration = 1000;
        private int mAudioFadeOutDuration = 1000;
         ...
         * 自定义播放核心
         */
        public Builder setPlayerFactory(PlayerFactory<? extends AbstractPlayer> playerFactory) {
         ...
         * 是否启用音频渐入渐出，默认不开启
         */
        public Builder setEnableAudioFade(boolean enableAudioFade) {
            mEnableAudioFade = enableAudioFade;
            return this;
        }
         ...
         * 设置音频渐入时长，默认1000ms
         */
        public Builder setAudioFadeInDuration(int durationMs) {
            mAudioFadeInDuration = durationMs;
            return this;
        }
         ...
         * 设置音频渐出时长，默认1000ms
         */
        public Builder setAudioFadeOutDuration(int durationMs) {
            mAudioFadeOutDuration = durationMs;
            return this;
        }
