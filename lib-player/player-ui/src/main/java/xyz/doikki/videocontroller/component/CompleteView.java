...
import me.lingci.lib.player.ui.databinding.DkplayerLayoutCompleteViewBinding;
...
public class CompleteView extends FrameLayout implements IControlComponent {
    ...
    private final DkplayerLayoutCompleteViewBinding mBinding;
    ...
    {
        setVisibility(GONE);
        mBinding = DkplayerLayoutCompleteViewBinding.inflate(LayoutInflater.from(getContext()), this, true);
        //LayoutInflater.from(getContext()).inflate(R.layout.dkplayer_layout_complete_view, this, true);
        mBinding.ivReplay.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public void onPlayerStateChanged(int playerState) {
        mBinding.stopFullscreen.setVisibility(VISIBLE);
    }
